      ...
      <>
          <article className="box w-[375px] h-[495.03px] bg-white rounded-[8px] outline-[1px] outline-[#D1D1D1] px-[20px] py-[40px] flex flex-col gap-[20px] m-8">
              ...
              <div className="w-[325px] h-[337.03px] bg-white flex flex-col gap-[32px]">
                  ...
                  <div className="buttons w-[325px] h-[105px] bg-white flex flex-col gap-[16px]">
                      <button className="w-[325px] h-[44px] px-[20px] py-[14px] rounded-[8px] outline-[1px] outline-[#D1D1D1] bg-[#4F4F4F] text-[#F5F5F5] text-sm flex items-center justify-center">Sign In</button>
                      <button className="w-[325px] h-[44px] px-[20px] py-[14px] rounded-[8px] outline-[1px] outline-[#D1D1D1] bg-[#FFFFFF] text-[#4F4F4F] text-sm flex items-center justify-center">Go To Log In</button>
                  </div>
              </div>
          </article>
      </>
